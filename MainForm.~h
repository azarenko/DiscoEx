...
__published:	// IDE-managed Components
        ...
        TLabel *Label7;
        TPanel *Panel3;
        TLineChart *__p3_LineChart;
        TScrollBar *__p3_vScrollBar;
        TGroupBox *GroupBox15;
        TCheckBox *__p3_EnCalculate;
        TLabel *Label8;
        TCSpinEdit *__p3_cylinder;
        TCSpinEdit *__p3_Position;
        TLabel *Label9;
        TLabel *__p3_LbCount;
        ...
        TPanel *Panel4;
        TLineChart *__p4_LineChart;
        TScrollBar *__p4_vScrollBar;
        TGroupBox *GroupBox17;
        TButton *__p4_Refresh;
        TLabel *Label14;
        TCSpinEdit *__p4_cylinder;
        TCSpinEdit *__p4_Gain;
        TLabel *Label15;
        TLabel *Label16;
        TCSpinEdit *__p4_Offset;
        TLabel *Label17;
        TLabel *Label18;
        TLabel *Label19;
        TLabel *Label20;
        ...
        void __fastcall __p3_cylinderChange(TObject *Sender);
        void __fastcall __p3_PositionChange(TObject *Sender);
        void __fastcall __p3_EnCalculateClick(TObject *Sender);
        void __fastcall __p3_LineChartChange(TObject *Sender);
        void __fastcall __p3_vScrollBarChange(TObject *Sender);
        void __fastcall _mOpenFileClick(TObject *Sender);
        void __fastcall _mSaveFileClick(TObject *Sender);
        void __fastcall __p3_CalculateData();
        void __fastcall __p4_CalculateData();
        void __fastcall __p4_RefreshClick(TObject *Sender);
        void __fastcall __p4_cylinderChange(TObject *Sender);
        void __fastcall __p4_GainChange(TObject *Sender);
        void __fastcall __p4_vScrollBarChange(TObject *Sender);
        void __fastcall __p4_OffsetChange(TObject *Sender);
